...
impl Wallet {
    ...
    pub fn dev() -> Self {
        // Private key from dev.toml
        let privkey_hex_str = "d00c06bfd800d27397002dca6fb0993d5ba6399b4238b2f29ee9deb97593d2bc";
        let lock: gw_jsonrpc_types::blockchain::Script = serde_json::from_str(
            r#"{
        ...
        hex_decode(privkey_hex_str.as_bytes(), &mut decoded).expect("create dev kong wallet");
        let privkey = Privkey::from_slice(&decoded);

        Wallet::new(privkey, lock.into())
    }
